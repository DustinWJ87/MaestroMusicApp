...
public class InformationAdapter extends ArrayAdapter<Information> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView informationATextView = (TextView) listItemView.findViewById(R.id.informationA);
        ...
        TextView informationBTextView = (TextView) listItemView.findViewById(R.id.informationB);
        // Get the information from the currentInformation object and set this text on the informationATextView
